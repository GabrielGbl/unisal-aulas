...
public class CityDAO extends GenericDAO{
	...
	public void delete(City city) throws SQLException, ClassNotFoundException, IOException{
	...
	public void update(City city) throws SQLException, ClassNotFoundException, IOException{
